...
from spectrogram_augmentation import augment_spectrograms
from convert_audio_to_spectrograms import process_audio_dataset
...
if __name__ == '__main__':
    # Define the directories [WHERE YOUR AUDIO FOLDERS ARE STORED [WHERE THE TRAIN & VAL FOLDERS ARE]
    root_directory = "audio_dataset/audio_dataset"

    train_audio_directory = os.path.join(root_directory, "train")
    val_audio_directory = os.path.join(root_directory, "val")

    # AUGMENT THE AUDIO
    print("AUGMENTING AUDIOS")
    augment_audio(train_audio_directory, train_audio_directory)


    # CONVERT AUDIOS TO SPECTROGRAMS
    print("converting audio files to mel spectograms")
    root_spectrograms_directory = os.path.join(root_directory, "spectrograms")
    os.makedirs(root_spectrograms_directory, exist_ok=True)

    process_audio_dataset(root_directory, root_spectrograms_directory)


    # AUGMENT THE SPECTROGRAMS
    train_directory = os.path.join(root_spectrograms_directory, "train")
    val_directory = os.path.join(root_spectrograms_directory, "val")

    augment_spectrograms(train_directory, train_directory)
    ...
    save_model(model_ft, "trained_model")
